...
echo '<fieldset><legend>Absent Learners</legend><br>Select the students you would like to register as absent and click the button:<br>';

$sql  = "SELECT *  FROM `StudentInformation` where `Transfered ?`='0' and $searchField LIKE '%$search%' ";
$result = mysql_query($sql);

echo 'Grade:' . $grade . '<form action="absentInsert.php" method="post"  onSubmit="popupform(this, \'join\')"><table BORDER=1 CELLPADDING=2 CELLSPACING=0 RULES=rows FRAME=box><tr><th>Check</th><th>Number</th><th>Name</th><th>Surname</th><th>Class</th><th>Reason</th><th>Excused?</th></tr>';
...
<br>
<br><input type="submit" value="Enter Absent" /></form>
